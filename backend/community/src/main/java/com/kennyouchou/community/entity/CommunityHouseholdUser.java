 ...
 */
@Data
@TableName("l_community_household_user")
@ApiModel(value = "CommunityHouseholdUser对象", description = "用户与户关联表")
public class CommunityHouseholdUser implements Serializable {
