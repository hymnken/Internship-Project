package com.kennyouchou.commons.annotation.logger;
...
public class LLoggerAnnotationInterceptor {
     ...
     * 切点
     * @author kennyouchou
     * @since 2022/10/4 12:06
     **/
    @Pointcut(value = "@annotation(com.kennyouchou.commons.annotation.logger.LLogger)")
